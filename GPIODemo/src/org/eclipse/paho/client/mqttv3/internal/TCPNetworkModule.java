...
//		log.setResourceName(resourceContext);
	...
	public TCPNetworkModule(SocketConnection socketconnection, String host, int port, String resourceContext) {
//		log.setResourceName(resourceContext);
...
/*			SocketAddress sockaddr = new InetSocketAddress(host, port);
			...
			sc.setSocketOption(SocketConnection.TIMEOUT, conTimeout*1000);
